...
public class MainCategoryAdapter extends RecyclerView.Adapter<MainCategoryAdapter.ViewHolder> {
    ...
    public MainCategoryAdapter(List<MainCategoriesModel> contents, Context mContext) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_home_main_category, parent, false);
...
//            Common.BASE_IMAGE_URL+
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        @BindView(R.id.main_category_image)ImageView image;
        @BindView(R.id.main_category_txt)TextView txt;

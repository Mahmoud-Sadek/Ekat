...
public class SubCategoryMenuAdapter extends RecyclerView.Adapter<SubCategoryMenuAdapter.ViewHolder> {

    private List<MainCategoriesModel> contents;
    private Context mContext;

    public SubCategoryMenuAdapter(List<MainCategoriesModel> contents, Context mContext) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_menu_sub_category, parent, false);
